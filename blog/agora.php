    ...
    <body class="body2"> 
        ...
        <div class="padd">
            ...
            if(isset($_GET["normal"]))
            {
                ...
                echo "<hr>";
                echo "<a href='agora.php?topic=".$title."' style='text-decoration:none;'><p class='h2edition' style='color:blue; margin-bottom:0%;'>".$title."</p></a>";
            ...
            if(isset($_GET["topic"]))
            {
                ...
                if(isset($_SESSION["users_id"]))
                {
                    ...
                    echo"<a href='agora.php?topic=".$topic."&action=thread' style='text-decoration:none; font-size:1.8vw; color:purple;'>Nuevo Hilo</a><br>";
                ...
                for($i=$len-1; $i>=0; $i=$i-1)
                {
                    ...
                    elseif($range==0)
                    {
                     ...
                     {
                         echo  "<a href='agora.php?topic=".$topic."&editthread=".$id."' style='text-decoration:none; font-size:1vw; color:purple;margin-left:2%;'>Editar</a><br><br>";
                    ...
                    echo "<p class='p4' style='padding-top:0%; padding-bottom:2%; margin-left:2%;'>".$answer."</p>";
                     ...
                     if(isset($_SESSION["users_id"]))
                     {
                         echo "<a href='agora.php?topic=".$topic."&action2=".$id."' style='text-decoration:none; font-size:1.5vw; color:blue;'>Responder</a><br><br>";
                    ...
                    for($v=$len2-1; $v>=0; $v=$v-1)
                    {
                        ...
                        if(isset($_SESSION["users_id"]) AND $responsable==$_SESSION["users_name"] )
                        {
                            echo  "<a href='agora.php?topic=".$topic."&editanswer=".$id."' style='text-decoration:none; font-size:1vw; color:purple;margin-left:2%;'>Editar</a><br><br>";
