...
else if($_SESSION["users_id"])
{
    ...
    if(isset($_POST['editinfo']))
    {
        ...
        <p>Nombre: <input type="text" name="name" placeholder="Nombre"> </p>
        <button type="submit" name="submitnewname">Editar</button>
        </form>
        ';
    
        echo '<form action="updateprofile.php" method="POST">
        <p>Nueva contraseña: <input type="password" name="password" placeholder="Nombre"></p><br>
        <p>Repita la contraseña: <input type="password" name="rpassword" placeholder="Nombre"></p>
        <button type="submit" name="submitnewpassword">Editar</button>
        </form>
        ';

        echo '
        <form action="updateprofile.php" method="POST" id="changerole">
            <p>Cambiar Rol</p>
            <button type="submit" name="submitrole">Editar</button>

            <select id="role" name="role" form="changerole">
