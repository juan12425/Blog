...
<ul class="menuul">
        ...
        <li class="menuli"><a class="amenu" href="#Novedades">Novedades</a></li>
        <li class="menuli"><a class="amenu" href="filósofos.php">Filósofos</a></li>
        <li class="menuli"><a class="amenu" href="Ágora.php">Ágora</a></li>
        <?php
            if(isset($_SESSION["users_id"])){
                ...
                echo "<li class='menuli' style='float:right; '><a class='amenu' href='sign-up.php' >Registrarse</a></li>";
